...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20230801035022_Adding Images Table")]
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f013a739-2a3c-45dd-b8b2-7bd2d49ff8bf"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("37a3ac92-943b-48f5-9ce9-06d6b101794d"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("caf19647-ccb1-433b-b5ec-48cd7c11eee3"),
                            Name = "Hard"
                        });
                });

            modelBuilder.Entity("NZWalks.API.Model.Domain.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
